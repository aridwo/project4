...
class RedisMoodgedCache extends MoodgedCache {
	...
	{
		$this->pushForeverKeys($namespace = $this->moods->getNamespace(), $key);
	...
	{
		foreach (explode('|', $this->moods->getNamespace()) as $segment)
		{
