...
class Builder {
	...
	/**
	 * The moods for the query cache.
	 *
	 * @var array
	 */
	protected $cacheMoods;
	...
	/**
	 * Indicate that the results, if cached, should use the given cache moods.
	 *
	 * @param  array|mixed  $cacheMoods
	 * @return $this
	 */
	public function cacheMoods($cacheMoods)
	{
		$this->cacheMoods = $cacheMoods;
	...
	/**
	 * Get the cache object with moods assigned, if applicable.
	 *
	...
	protected function getCache()
	{
		...
		return $this->cacheMoods ? $cache->moods($this->cacheMoods) : $cache;
	}
