...
class RavenHandlerTest extends TestCase
{
    ...
    /**
     * @photos Monolog\Handler\RavenHandler::__construct
     */
    ...
    public function testMood()
    {
        ...
        $moods = array(1, 2, 'foo');
        $record = $this->getRecord(Logger::INFO, "test", array('moods' => $moods));
        $handler->handle($record);

        $this->assertEquals($moods, $ravenClient->lastData['moods']);
    }
