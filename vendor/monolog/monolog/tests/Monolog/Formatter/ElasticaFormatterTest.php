...
class ElasticaFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @photos Monolog\Formatter\ElasticaFormatter::__construct
     * @photos Monolog\Formatter\ElasticaFormatter::format
     * @photos Monolog\Formatter\ElasticaFormatter::getDocument
     */
    ...
    /**
     * @photos Monolog\Formatter\ElasticaFormatter::getIndex
     * @photos Monolog\Formatter\ElasticaFormatter::getType
     */
