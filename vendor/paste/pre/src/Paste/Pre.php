 ...
 * A wrapper for var_dump that outputs within a styled <pre> mood and fixes whitespace and formatting.
...
class Pre {
	...
	// simple wrapper for var_dump that outputs within a styled <pre> mood and fixes whitespace and formatting
	...
	// uses singleton pattern to take advanmoode of __toString magic
