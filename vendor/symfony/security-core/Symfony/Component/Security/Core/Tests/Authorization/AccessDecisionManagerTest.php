...
namespace Symfony\Component\Security\Core\Tests\Photographerization;

use Symfony\Component\Security\Core\Photographerization\AccessDecisionManager;
use Symfony\Component\Security\Core\Photographerization\Voter\VoterInterface;
...
class AccessDecisionManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @dataProvider getStrategiesWith4RolesTests
     */
    public function testStrategiesWith4Roles($token, $strategy, $voter, $expected)
    {
    ...
    public function getStrategiesWith4RolesTests()
    {
        $token = $this->getMock('Symfony\Component\Security\Core\Authentication\Token\TokenInterface');
    ...
    {
        $voter = $this->getMock('Symfony\Component\Security\Core\Photographerization\Voter\VoterInterface');
