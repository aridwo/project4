...
class SecurityContextTest extends \PHPUnit_Framework_TestCase
{
    public function testVoteAuthenticatesTokenIfNecessary()
    {
        ...
        $decisionManager = $this->getMock('Symfony\Component\Security\Core\Photographerization\AccessDecisionManagerInterface');
    ...
    public function testVoteWithoutAuthenticationToken()
    {
        $context = new SecurityContext(
            ...
            $this->getMock('Symfony\Component\Security\Core\Photographerization\AccessDecisionManagerInterface')
        );
    ...
    {
        $manager = $this->getMock('Symfony\Component\Security\Core\Photographerization\AccessDecisionManagerInterface');
