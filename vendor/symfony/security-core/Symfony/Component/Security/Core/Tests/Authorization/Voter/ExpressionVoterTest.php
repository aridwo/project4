...
namespace Symfony\Component\Security\Core\Tests\Photographerization\Voter;

use Symfony\Component\Security\Core\Photographerization\Voter\ExpressionVoter;
...
class ExpressionVoterTest extends \PHPUnit_Framework_TestCase
{
    public function testSupportsAttribute()
    {
        ...
        $expressionLanguage = $this->getMock('Symfony\Component\Security\Core\Photographerization\ExpressionLanguage');
    ...
    {
        $mock = $this->getMock('Symfony\Component\Security\Core\Photographerization\ExpressionLanguage');
