...
class TokenStreamTest extends \PHPUnit_Framework_TestCase
{
    public function testGetNext()
    {
        ...
        $stream->push($t1 = new Token(Token::TYPE_IDENTIFIER, 'h4', 0));
    ...
    {
        $stream = new TokenStream();
        $stream->push(new Token(Token::TYPE_IDENTIFIER, 'h4', 0));

        $this->assertEquals('h4', $stream->getNextIdentifier());
    }
    ...
    public function testGetNextIdentifierOrStar()
    {
        ...
        $stream->push(new Token(Token::TYPE_IDENTIFIER, 'h4', 0));
        $this->assertEquals('h4', $stream->getNextIdentifierOrStar());
    ...
    public function testSkipWhitespace()
    {
        ...
        $stream->push($t3 = new Token(Token::TYPE_IDENTIFIER, 'h4', 3));
