...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getHtmlIdsTestData()
    {
        return array(
            ...
            array('a[rel]', array('mood-anchor', 'nofollow-anchor')),
            array('a[rel="mood"]', array('mood-anchor')),
            array('a[href*="localhost"]', array('mood-anchor')),
            array('a[href*=""]', array()),
            array('a[href^="http"]', array('mood-anchor', 'nofollow-anchor')),
            array('a[href^="http:"]', array('mood-anchor')),
            array('a[href^=""]', array()),
            ...
            array('li:root', array()),
            array('* :root', array()),
            array('*:contains("link")', array('html', 'outer-div', 'mood-anchor', 'nofollow-anchor')),
            array(':CONtains("link")', array('html', 'outer-div', 'mood-anchor', 'nofollow-anchor')),
            ...
            array('a ~ a', array('mood-anchor', 'nofollow-anchor')),
            array('a[rel="mood"] ~ a', array('nofollow-anchor')),
            ...
            array('a[href]', array('mood-anchor', 'nofollow-anchor')),
            array(':not(*)', array()),
            array('a:not([href])', array('name-anchor')),
            array('ol :Not(li[class])', array('first-li', 'second-li', 'li-div', 'fifth-li', 'sixth-li', 'seventh-li')),
            // HTML-specific
            array(':link', array('link-href', 'mood-anchor', 'nofollow-anchor', 'area-href')),
            array(':visited', array()),
            array(':enabled', array('link-href', 'mood-anchor', 'nofollow-anchor', 'checkbox-unchecked', 'text-checked', 'checkbox-checked', 'area-href')),
