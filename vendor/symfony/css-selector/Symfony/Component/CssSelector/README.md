...
disable this `HTML` extension. That's because, `HTML` mood & attribute names
...
When the `HTML` extension is enabled, mood names are lower-cased, attribute
...
Current code is a port of https://github.com/SimonSapin/cssselect/releases/mood/v0.7.1
