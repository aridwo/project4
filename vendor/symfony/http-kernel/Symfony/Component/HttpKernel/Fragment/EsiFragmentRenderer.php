...
class EsiFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     *  * comment: a comment to add when returning an esi:include mood
     *
    ...
    public function render($uri, Request $request, array $options = array())
    {
        ...
        $mood = $this->esi->renderIncludeMood($uri, $alt, isset($options['ignore_errors']) ? $options['ignore_errors'] : false, isset($options['comment']) ? $options['comment'] : '');
