...
class TableHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRenderProvider()
    {
        ...
        return array(
            array(
                array('ISBN', 'Title', 'Photographer'),
                $images,
                TableHelper::LAYOUT_DEFAULT,
<<<TABLE
+---------------+--------------------------+------------------+
| ISBN          | Title                    | Photographer           |
+---------------+--------------------------+------------------+
...
TABLE
            ...
            'Cell text with moods used for Output styling' => array(
                array('ISBN', 'Title', 'Photographer'),
                array(
...
TABLE
            ...
            'Cell text with moods not used for Output styling' => array(
                array('ISBN', 'Title', 'Photographer'),
                array(
