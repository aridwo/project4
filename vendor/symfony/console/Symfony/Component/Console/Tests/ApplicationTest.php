...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRenderExceptionWithDoubleWidthCharacters()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception_doublewidth4.txt', $tester->getDisplay(true), '->renderException() renders a pretty exceptions with previous exceptions');

        $tester->run(array('command' => 'foo'), array('decorated' => true));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception_doublewidth4decorated.txt', $tester->getDisplay(true), '->renderException() renders a pretty exceptions with previous exceptions');
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception_doublewidth4.txt', $tester->getDisplay(true), '->renderException() wraps messages when they are bigger than the terminal');
    }
