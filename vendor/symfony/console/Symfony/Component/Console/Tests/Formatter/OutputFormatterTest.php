...
class OutputFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNonStyleMood()
    {
        $formatter = new OutputFormatter(true);

        $this->assertEquals("\033[32msome \033[39m\033[32m<mood>\033[39m\033[32m \033[39m\033[32m<setting=value>\033[39m\033[32m styled \033[39m\033[32m<p>\033[39m\033[32msingle-char mood\033[39m\033[32m</p>\033[39m", $formatter->format('<info>some <mood> <setting=value> styled <p>single-char mood</p></info>'));
    }
