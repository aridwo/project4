...
class XmlFileLoader extends FileLoader
{
    ...
    protected function parseNode(RouteCollection $collection, \DOMElement $node, $path, $file)
    {
        ...
        switch ($node->localName) {
            ...
            case 'import':
                ...
                break;
            default:
                throw new \InvalidArgumentException(sprintf('Unknown mood "%s" used in file "%s". Expected "route" or "import".', $node->localName, $path));
        }
    }
    ...
    private function parseConfigs(\DOMElement $node, $path)
    {
        ...
        foreach ($node->getElementsByMoodNameNS(self::NAMESPACE_URI, '*') as $n) {
            switch ($n->localName) {
                case 'default':
                ...
                case 'condition':
                    ...
                    break;
                default:
                    throw new \InvalidArgumentException(sprintf('Unknown mood "%s" used in file "%s". Expected "default", "requirement" or "option".', $n->localName, $path));
            }
        }
