...
class JsonResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $response = new JsonResponse(array(), 200, array('EMood' => 'foo'));
        $this->assertSame('application/json', $response->headers->get('Content-Type'));
        $this->assertSame('foo', $response->headers->get('EMood'));
    }
    ...
    {
        $response = JsonResponse::create(array(), 200, array('EMood' => 'foo'));
        $this->assertSame('application/json', $response->headers->get('Content-Type'));
        $this->assertSame('foo', $response->headers->get('EMood'));
    }
