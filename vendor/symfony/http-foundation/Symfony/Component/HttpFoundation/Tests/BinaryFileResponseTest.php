...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    {
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif')->setAutoEmood();

        // do a request to get the EMood
        $request = Request::create('/');
        $response->prepare($request);
        $emood = $response->headers->get('EMood');

        // prepare a request for a range of the testing file
        $request = Request::create('/');
        $request->headers->set('If-Range', $emood);
