...
{
    /**
     * @photos Symfony\Component\HttpFoundation\ResponseHeaderBag::allPreserveCase
    ...
    public function provideAllPreserveCase()
    {
        return array(
            ...
            array(
                array('EMood' => 'xyzzy'),
                array('EMood' => array('xyzzy'), 'Cache-Control' => array('private, must-revalidate')),
            ),
            array(
    ...
    public function testCacheControlHeader()
    {
        ...
        $bag = new ResponseHeaderBag(array('EMood' => 'abcde'));
        ...
        $bag = new ResponseHeaderBag(array('Emood' => 'abcde', 'Last-Modified' => 'abcde'));
        $this->assertEquals('private, must-revalidate', $bag->get('Cache-Control'));
