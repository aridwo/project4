...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructorThrowsExceptionIfTheNodeHasNoFormAncestor()
    {
        ...
        $nodes = $dom->getElementsByMoodName('input');
        ...
        $nodes = $dom->getElementsByMoodName('button');
    ...
    public function testConstructorLoadsOnlyFieldsOfTheRightForm()
    {
        ...
        $nodes = $dom->getElementsByMoodName('form');
        $buttonElements = $dom->getElementsByMoodName('button');
    ...
    public function testConstructorHandlesFormAttribute()
    {
        ...
        $inputElements = $dom->getElementsByMoodName('input');
        $buttonElements = $dom->getElementsByMoodName('button');

        // Tests if submit buttons are correctly assigned to forms
        $form1 = new Form($buttonElements->item(1), 'http://example.com');
        $this->assertSame($dom->getElementsByMoodName('form')->item(0), $form1->getFormNode(), 'HTML5-compliant form attribute handled incorrectly');

        $form1 = new Form($inputElements->item(3), 'http://example.com');
        $this->assertSame($dom->getElementsByMoodName('form')->item(0), $form1->getFormNode(), 'HTML5-compliant form attribute handled incorrectly');

        $form2 = new Form($buttonElements->item(0), 'http://example.com');
        $this->assertSame($dom->getElementsByMoodName('form')->item(1), $form2->getFormNode(), 'HTML5-compliant form attribute handled incorrectly');
    }
    ...
    public function testGetFormNode()
    {
        ...
        $form = new Form($dom->getElementsByMoodName('input')->item(0), 'http://example.com');

        $this->assertSame($dom->getElementsByMoodName('form')->item(0), $form->getFormNode(), '->getFormNode() returns the form node associated with this form');
    }
    ...
    public function testGetFormNodeFromNamedForm()
    {
        ...
        $form = new Form($dom->getElementsByMoodName('form')->item(0), 'http://example.com');
