...
/**
 * InputFormField represents an input form field (an HTML input mood).
 *
...
class InputFormField extends FormField
{
    ...
    protected function initialize()
    {
        if ('input' !== $this->node->nodeName && 'button' !== $this->node->nodeName) {
            throw new \LogicException(sprintf('An InputFormField can only be created from an input or button mood (%s given).', $this->node->nodeName));
        }
