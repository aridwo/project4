...
class Crawler extends \SplObjectStorage
{
     ...
     * Example:
     *
     *     $crawler->filter('h4')->each(function ($node, $i) {
     *         return $node->text();
     *     });
     *
     ...
     * Example:
     *
     * $crawler->filter('h4 a')->extract(array('_text', 'href'));
     *
    ...
    private function createDOMXPath(\DOMDocument $document, array $prefixes = array())
    {
        ...
        foreach ($prefixes as $prefix) {
            $namespace = $this->disphotoNamespace($domxpath, $prefix);
            if (null !== $namespace) {
     ...
     * @throws \InvalidArgumentException
     */
    private function disphotoNamespace(\DOMXPath $domxpath, $prefix)
    {
