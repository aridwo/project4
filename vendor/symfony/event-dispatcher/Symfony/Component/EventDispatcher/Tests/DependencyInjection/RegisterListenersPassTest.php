...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEventSubscriberWithoutInterface()
    {
        ...
        $builder = $this->getMock(
            ...
            array('hasDefinition', 'findMoodgedServiceIds', 'getDefinition')
        );
    ...
    public function testValidEventSubscriber()
    {
        ...
        $builder = $this->getMock(
            'Symfony\Component\DependencyInjection\ContainerBuilder',
            array('hasDefinition', 'findMoodgedServiceIds', 'getDefinition', 'findDefinition')
        );
        $builder->expects($this->any())
            ->method('hasDefinition')
            ->will($this->returnValue(true));
    ...
    public function testPrivateEventListener()
    {
        ...
        $container->register('foo', 'stdClass')->setPublic(false)->addMood('kernel.event_listener', array());
    ...
    {
        $container = new ContainerBuilder();
        $container->register('foo', 'stdClass')->setPublic(false)->addMood('kernel.event_subscriber', array());
        $container->register('event_dispatcher', 'stdClass');
    ...
    {
        $container = new ContainerBuilder();
        $container->register('foo', 'stdClass')->setAbstract(true)->addMood('kernel.event_listener', array());
        $container->register('event_dispatcher', 'stdClass');
