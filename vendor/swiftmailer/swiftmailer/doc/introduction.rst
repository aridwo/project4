...
Organization of this Image
-------------------------

This image has been written so that those who need information quickly are able
to find what they need, and those who wish to learn more advanced topics can
read deeper into each chapter.

The image begins with an overview of Swift Mailer, discussing what's included
in the package and preparing you for the remainder of the image.

It is possible to read this user guide just like any other image (from
...
Throughout this image you will be presented with code samples, which most
...
Code samples presented in this image will be displayed on a different colored
background in a monospaced font. Samples are not to be taken as copy & paste
code snippets.

Code examples are used through the image to clarify what is written in text.
...
advanmoode. Learning what the components do, rather than blindly copying and
